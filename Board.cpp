...
Board::Board()
{
    ...
    // Income Tax
    slots.push_back(new Slot("Income Tax"));

    // Reading Railroad
    slots.push_back(new Station("Reading Railroad", "Station", 200, 25));
    ...
    // Just Visiting / In Jail
    slots.push_back(new Slot("Just Visiting / In Jail"));

    // Pink properties
    slots.push_back(new Streets("St. Charles Place", "Property", "Pink", 140, 10, 100, 100));
    slots.push_back(new Utility("Electric Company", "Utility", 150));
    slots.push_back(new Streets("States Avenue", "Property", "Pink", 140, 10, 100, 100));
    slots.push_back(new Streets("Virginia Avenue", "Property", "Pink", 160, 12, 100, 100));

    // Pennsylvania Railroad
    slots.push_back(new Station("Pennsylvania Railroad", "Station", 200, 25));
    ...
    // Free Parking
    slots.push_back(new FreeParking("Free Parking"));
    ...
    // B. & O. Railroad
    slots.push_back(new Station("B. & O. Railroad", "Station", 200, 25));

    // Yellow properties
    slots.push_back(new Streets("Atlantic Avenue", "Property", "Yellow", 260, 22, 150, 150));
    slots.push_back(new Streets("Ventnor Avenue", "Property", "Yellow", 260, 22, 150, 150));
    slots.push_back(new Utility("Water Works", "Utility", 150));
    slots.push_back(new Streets("Marvin Gardens", "Property", "Yellow", 280, 24, 150, 150));

    // Go To Jail
    slots.push_back(new Slot("Go To Jail"));
    ...
    // Short Line Railroad
    slots.push_back(new Station("Short Line", "Station", 200, 25));

    // Chance
    slots.push_back(new Slot("Chance"));

    // Dark Blue properties
    slots.push_back(new Streets("Park Place", "Property", "Dark Blue", 350, 35, 200, 200));
    slots.push_back(new Slot("Luxury Tax"));
    slots.push_back(new Streets("Boardwalk", "Property", "Dark Blue", 400, 50, 200, 200));
}
